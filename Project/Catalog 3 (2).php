...
<html>
 ...
 <body>
  ...
  <br></br>
  <span class="Group1">&ensp;&ensp;Puma Deviate Running Shoes</span><span class="Group2">&ensp;&ensp;&ensp;&ensp;&ensp;Puma Nitro Shoes</span><span class="Group3">Vans Classic Sneakers</span>
  <br></br>
  ...
  <br></br>
  <span class="Group1">&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;Vans Classic Slip-ons</span><span class="Group2">&ensp;&ensp;&ensp;&ensp;Vans Sk8 HI</span><span class="Group3">&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;Vans Boots</span>
  <br></br>
  <button class="cart1" OnClick="Add()">Add to cart</button><button class="cart2" OnClick="Add()">Add to cart</button><button class="cart3" OnClick="Add()">Add to cart</button>
  <br></br>
  ...
  <br></br>
  <span class="Group1">Vans Cross Strap Flip Flops</span><span class="Group2">Crocs Classic Flip Flops</span><span class="Group3">Crocs Salahe Bembury</span>
  <br></br>
  <button class="cart1" OnClick="Add()">Add to cart</button><button class="cart2" OnClick="Add()">Add to cart</button><button class="cart3" OnClick="Add()">Add to cart</button>
  <br>
